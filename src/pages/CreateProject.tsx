    ...
    <div className="min-h-screen bg-background pb-20 md:pb-0">
      <div className="container mx-auto px-4 py-4 md:py-6 max-w-4xl">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-2xl md:text-3xl font-bold mb-2">Создать новый проект</h1>
        ...
        <div className="space-y-6">
            ...
            {!referenceImage ? (
              <label className="block">
                <input
                  ...
                  className="hidden"
                />
                <div className="border-2 border-dashed border-primary bg-primary/5 rounded-lg p-12 text-center cursor-pointer hover:bg-primary/10 transition-colors">
          ...
          {/* Settings */}
          <Card className="p-6">
            <h3 className="font-semibold mb-4">Настройки генерации</h3>
